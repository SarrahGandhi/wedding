...
import { accommodationLabel, compareNames, formatArrival, matchesFamily, travelLabel, type Accommodation, type LogisticsFamily } from "@/lib/logistics";
  ...
  return (
    <article id={`family-${family.id}`} className="border-t border-border/60 py-6">
      ...
      <dl className="mt-5 grid gap-4 text-sm sm:grid-cols-3">
        <div><dt className="mb-1 text-text-secondary">Travelling by</dt><dd>{travelLabel(family.logistics?.travel_mode)}</dd></div>
